...
$key = q/ell_{{rm{max};MSF=1.6;LFS=12;AAT/;
$cached_env_img{$key} = q|<IMG
...
$key = q/[0,ell_{{rm{max}];MSF=1.6;LFS=12;AAT/;
$cached_env_img{$key} = q|<IMG
 WIDTH="67" HEIGHT="37" ALIGN="MIDDLE" BORDER="0"
 SRC="|."$dir".q|installimg6.png"
 ALT="$[0, \ell_{\rm max}]$">|; 

$key = q/C(ell);MSF=1.6;LFS=12;AAT/;
$cached_env_img{$key} = q|<IMG
...
$key = q/langleldotsrangle;MSF=1.6;LFS=12;AAT/;
$cached_env_img{$key} = q|<IMG
...
$key = q/a_{ellm};MSF=1.6;LFS=12;AAT/;
$cached_env_img{$key} = q|<IMG
