...
l,vlsmica = np.loadtxt('./vsk_angular_power_spectrum/frequency-maps/vl_100.cl',unpack=True,usecols=[0,1])

slsmica = np.loadtxt('./vsk_angular_power_spectrum/frequency-maps/sl_100.cl',unpack=True,usecols=[1])

klsmica = np.loadtxt('./vsk_angular_power_spectrum/frequency-maps/kl_100.cl',unpack=True,usecols=[1])
...
for index in range(1,number_maps+1):
    ...
    vl[:,index-1] = np.loadtxt('./vsk_angular_power_spectrum/frequency-maps/planck-simulations/100/vl_'+str(index).zfill(4)+'.cl',unpack=True,usecols=[1])

    sl[:,index-1] = np.loadtxt('./vsk_angular_power_spectrum/frequency-maps/planck-simulations/100/sl_'+str(index).zfill(4)+'.cl',unpack=True,usecols=[1])

    kl[:,index-1] = np.loadtxt('./vsk_angular_power_spectrum/frequency-maps/planck-simulations/100/kl_'+str(index).zfill(4)+'.cl',unpack=True,usecols=[1])
...
py.plot(l[1:],vlsmica[1:],label=r'100 GHz + UT78',linestyle=':')
...
py.savefig("./figures/Vl_ut78_100.pdf")

py.close(1)

py.figure(2)

py.plot(l[1:],slsmica[1:],label=r'100 GHz + UT78',linestyle=':')
...
py.savefig("./figures/Sl_ut78_100.pdf")

py.close(2)

py.figure(3)

py.plot(l[1:],klsmica[1:],label=r'100 GHz + UT78',linestyle=':')
...
py.savefig("./figures/Kl_ut78_100.pdf")
...
py.vlines(smicavchi2,0,ymax,linestyle='dashed',label=r'100 GHz * UT78')

py.legend(loc=0)

py.savefig("./figures/vchi2_100.pdf")
...
py.vlines(smicaschi2,0,ymax,linestyle='dashed',label=r'100 GHz * UT78')

py.legend(loc=0)

py.savefig("./figures/schi2_100.pdf")
...
py.vlines(smicakchi2,0,ymax,linestyle='dashed',label=r'100 GHz * UT78')

py.legend()

py.savefig("./figures/kchi2_100.pdf")
