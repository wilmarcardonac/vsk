...
subroutine do_legendre(nlmax, mumin, mu, w, Pl, verbose, ncor)
!=======================================================================
...
!=======================================================================
  ...
  real(DP), intent(out) :: Pl(0:nlmax,0:nlmax,0:ncor-1)
  logical, intent(in)   :: verbose

  integer(I4B) itheta
  real(DP) :: secPl(0:nlmax,0:ncor-1)
  ...
  do itheta = 0, nlmax
     call Legendre(nlmax, mu(itheta+1), secPl, ncor)
     Pl(itheta,:,:) = secPl
  end do
...
!=======================================================================
subroutine Legendre(nlmax, x, Pl, ncor)
!=======================================================================
...
!=======================================================================
  ...
  integer(I4B), intent(in)  :: nlmax, ncor
  real(DP),     intent(in)  :: x
  real(DP),     intent(out) :: Pl(0:nlmax,0:ncor-1)
  !
  integer(I4B) :: l
  real(DP) :: dl, s, m, sign
  real(DP) :: t1, t2, t3, t4
