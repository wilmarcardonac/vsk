...
!=======================================================================
  ...
  write(*,9) '   than beam2 should be explicitely given the same value as beam'
  write(*,9)
  ...
  write(*,9) '   for the beam.'
  write(*,9) '  Note: if the second beam is the same as the first one,'
  write(*,9) '   than beam_file2 should be explicitely given the same value as beam_file'
  write(*,9)
 ...
 &           //trim(cl_file_name_default)
  ...
  write(*,9) '   additional spectra corresponding to EE, BB, TE, TB and EB are also written.'
  write(*,9)
 ...
 &           //trim(cor_file_name_default)
  ...
  write(*,9) '   otherwise it is ignored.'
  ...
  write(*,9) '      options -windowfilein, -windowfileout).'
  write(*,9) 
  ...
  write(*,9) '   If set, the Cl and correlation (clfile, corfile, cl_out*file) '
  ...
  write(*,9) '   Compute and ouput the kernels relating the Spice estimator to the'
  write(*,9) "   'true' underlying CMB spectra. "
  ...
  write(*,9) '     This option is inactive if option -windowfilein is active, or'
  write(*,9) '   if options -polarization is inactive.'
  ...
  write(*,9) '   list of map files to be combined with weights lismapweights1_K'
  ...
  write(*,9) '   with K integer in [1, '//trim(string(nefmax,format='(i2)'))//']'
  write(*,9) '   list of map files to be combined with weights lismapweights2_K'
  ...
  write(*,9) '   with K integer in [1, '//trim(string(nefmax,format='(i2)'))//']'
  write(*,9) '   list of weights to be applied to lismapfiles1_K above'
  write(*,9) '   to form the first map to analyze.'
  write(*,9) '   m1 = w1(1) * m1(1) + w1(2) * m1(2) + ... '
  write(*,9)
  write(*,9) '-listmapweights2_K [dfloat|'//trim(none)//'](1.0)'
  write(*,9) '   with K integer in [1, '//trim(string(nefmax,format='(i2)'))//']'
  write(*,9) '   list of weights to be applied to lismapfiles2_K above'
...
!   write(*,9)
 ...
 &               //trim(spice_rc_file_default)
  ...
  write(*,9) '   NOTE 1 : The file containing the options is a 2 columns file,'
 ...
 &               //trim(spice_rc_file_default)
  ...
  write(*,9) '   name of input pixel correction file'
  ...
  write(*,9) '   Smaller values give more accurate results in longer times.'
 ...
 &           //trim(weightfile2_default)//'.fits'
  ...
  write(*,9) 
  write(*,9) 'If thereis any mask/weight, the order of operations is the following'
...
!  write(*,9) '   (5b) pair count thresholding, if required'
 ...
 &            ' -clfile '//trim(default)
  ...
  write(*,9) '   option -noiscorfile or from the option -noiseclfile,'
...
!=======================================================================
  ...
  write(*,9)
  write(*,9)
  write(*,9) 'The software can be downloaded from http://www.planck.fr/article141.html'
  write(*,9)
  write(*,9)
  write(*,9) 'LICENSE INFORMATION'
  write(*,9) 
  write(*,9) 'This sofware in an extension of the HEALPix package, version 2.0'
  ...
  write(*,9) 'http://healpix.jpl.nasa.gov'
  write(*,9)
  write(*,9)
  write(*,9) 'DISCLAIMER'  
  write(*,9) 
...
!   write(*,9) '                           added -version option'
  ...
  write(*,9) '2015-10-12/EH        : version 3.16'
...
!=======================================================================
  ...
  ! if count==F and create==T : create list of options with default value
  ...
  if ((.not.count) .and. j == inc) then
     if (create) then
        ...
        if (i < narguments) then
           ...
           if (pixwin_file_name_input == default) then
              correct_pix=.true.
           elseif (pixwin_file_name_input /= none) then
