...
! edited to run with Healpix 1.2 2003-06
  ...
  integer(I4B) :: nside,npixtot,nmap,ncor
  ...
  real(DP), allocatable, dimension(:,:)   :: wl,gb,gb2
  ...
  character(len=FILENAMELEN) :: pixwin_file_name
  ...
  character(len=FILENAMELEN) :: pixwin_file_name_input
